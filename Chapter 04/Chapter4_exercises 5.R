# a
vec.sex <- c(
  "F", rep("M", times = 3), rep("F", times = 3), rep("M", times = 4),
  "F", "M", rep("F", times = 3), rep("M", times = 4)
)
vec.par <- c(
  "Labour", "National", "National", "Labour", "National", "Greens",
...
# e
vec.conf <- c(
  93, 55, 29, 100, 52, 84, 56, 0, 33, 52, 35, 53, 55, 46, 40, 40, 56, 45, 64, 31, 10,
  29, 40, 95, 8, 62
)
br <- c(0, 30, 70, 100)
